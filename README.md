...
Type-safe server actions for Nuxt with end-to-end validation & composable middleware.
...
Real-time listing surveillance with Discord & email alerts.
...
ioredis vs node-redis benchmarks for data-driven client selection.
...
| Project | Description |
|---------|-------------|
| Project Foxxy | Guild management — scheduling, admin dashboard, Discord bot |
| WoW Collector | Achievement & collectables tracker |
| Bloodlust Boosting | Scandinavia's largest WoW community (ended 2022) |
